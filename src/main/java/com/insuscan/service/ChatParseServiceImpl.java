...
public class ChatParseServiceImpl implements ChatParseService {
    ...
    public ChatParseServiceImpl(WebClient.Builder webClientBuilder, ObjectMapper objectMapper) {
    ...
    private ChatParseResponse parseResponse(String rawResponse) {
        try {
            ...
            if (choices == null || !choices.isArray() || choices.isEmpty()) {
                return fallbackResponse("No response from AI");
            }
            ...
            if (start == -1 || end == -1 || end <= start) {
                return fallbackResponse("Invalid AI response format");
            }
