...
public class FakeMealFactory {
    ...
    private MealBoundary build(String title, Date scannedAt, float totalCarbs, float dose,
                               String activityLevel, int glucose, List<FoodItemBoundary> items) {
        ...
        meal.setWasSickMode(false);
        meal.setWasStressMode(false);
