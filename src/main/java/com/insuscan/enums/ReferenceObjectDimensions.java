...
public enum ReferenceObjectDimensions {
	...
	INSULIN_PEN("INSULIN_PEN", 16.0f, 2.0f, 2.0f,
		    "INSULIN PEN — a slim cylindrical medical pen (like a NovoPen or FlexPen), approximately 16.0cm long and 2.0cm in diameter. It looks like a thick marker or a large pen, placed next to the plate."),
