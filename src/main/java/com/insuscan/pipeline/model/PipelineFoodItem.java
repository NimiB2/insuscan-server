...
/**
 * A single food item that accumulates data as it passes through pipeline stages 3–9.
 *
 * <p>Each stage is responsible for filling only its own fields.
 * No stage should read fields written by a later stage.</p>
 *
 * <p>Stage responsibilities:</p>
 * <ul>
 *   <li>Stage 3 (FoodDetection): name, baseIngredient, visualState, boundingBoxPct, searchTerms,
 *       detectionConfidence, requiresUserValidation, effectiveDensityFactor</li>
 *   <li>Stage 4 (FoodArea): areaCm2, coveragePercent, areaConfidence</li>
 *   <li>Stage 5 (FoodHeight): effectiveHeightCm, heightConfidence, heightWarnings</li>
 *   <li>Stage 6 (VolumeCalculator): volumeCm3</li>
 *   <li>Stage 7 (NutritionAndDensity): nutritionPer100g, densityGPerCm3, densitySource, foundInUsda, usdaItemId</li>
 *   <li>Stage 8 (WeightCalculator): weightG, weightWarnings</li>
 *   <li>Stage 9 (NutritionAggregator): carbsG, netCarbsG, proteinG, fatG, fiberG</li>
 * </ul>
 */
public class PipelineFoodItem {
    ...
    /**
     * Effective density factor (0.3–1.0) estimated by the vision model.
     * Represents the fraction of the visual volume that is actual food (vs. air).
     * Used only in DensitySource.PROXIMATE_WITH_TEXTURE.
     * Example: bread ≈ 0.65, leafy salad ≈ 0.35, solid chicken ≈ 1.0
     */
